...
[![Version](https://img.shields.io/badge/version-2.5.5-blue.svg)](./CHANGELOG.md)
...
4. 确认名称为 `豆包图片视频去水印`（DoubaoWaterMark-Remover）、版本 `2.5.5`  
...
![新生成图片无水印](https://s1.mnat.cn/2026/09/03/6a9943bb5ed8b.png)
